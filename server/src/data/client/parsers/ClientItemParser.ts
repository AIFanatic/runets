...
export class ClientItemParser {
    public static ParseItemDefinitions(indices: DefinitionIndex[], archive: CacheArchive): Map<number, ClientItemDefinition> {
        const buffer = archive.getFileData('obj.dat');
        const itemDefinitions: Map<number, ClientItemDefinition> = new Map<number, ClientItemDefinition>();
