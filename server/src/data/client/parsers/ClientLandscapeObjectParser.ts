import { DefinitionIndex } from "@runeserver-ts/data/client/CacheIndices";
...
export class ClientLandscapeObjectParser {
    public static ParseLandscapeObjectDefinitions(indices: DefinitionIndex[], archive: CacheArchive): Map<number, ClientLandscapeObjectDefinition> {
        const buffer = archive.getFileData('loc.dat');
        const landscapeObjectDefinitions: Map<number, ClientLandscapeObjectDefinition> = new Map<number, ClientLandscapeObjectDefinition>();
