...
export class ClientNpcParser {
    public static ParseNpcDefinitions(indices: DefinitionIndex[], archive: CacheArchive): Map<number, ClientNpcDefinition> {
        const buffer = archive.getFileData('npc.dat');
        const npcDefinitions: Map<number, ClientNpcDefinition> = new Map<number, ClientNpcDefinition>();
